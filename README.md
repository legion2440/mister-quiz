...
- PHP `^7.3` или `^8.0` согласно `composer.json`;
- Composer;
...
Laravel в проекте старой ветки 8.x. В проекте есть compatibility bootstrap, который убирает deprecated-warning'и старых зависимостей на новых PHP-версиях.
